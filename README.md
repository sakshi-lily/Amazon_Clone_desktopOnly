# 🛒 Amazon Clone (Desktop Only)

A desktop-only clone of the Amazon homepage built using **HTML** and **CSS**. This project replicates the design and layout of Amazon's landing page while helping strengthen front-end development skills.
